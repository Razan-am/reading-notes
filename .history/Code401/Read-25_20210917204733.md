...
- **reducer** : reducers are there to manage state in an application. For instance, if a user writes something in an HTML input field, the application has to manage this UI state
-----------------------------------------------
